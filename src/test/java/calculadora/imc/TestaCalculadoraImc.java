//FEITO POR GABRIEL ROLIM E LUCAS DIAS
...
public class TestaCalculadoraImc {
	...
	public void testeMenino2anosBaixoPeso() {
		Assert.assertEquals("Baixo peso", calc.calcularImc(5.06, 0.6, 2, "M"));
	}

	@Test
	public void testeMenino2anosPesoNormalMinimo() {
		Assert.assertEquals("Peso normal", calc.calcularImc(5.50, 0.6, 2, "M"));
	}

	@Test
	public void testeMenino2anosPesoNormalMaximo() {
		Assert.assertEquals("Peso normal", calc.calcularImc(8.819, 0.7, 2, "M"));
	}

	@Test
	public void testeMenino2anosSobrePesoMinimo() {
		Assert.assertEquals("Sobrepeso", calc.calcularImc(9.31, 0.7, 2, "M"));
	}

	@Test
	public void testeMenino2anosSobrePesoMaximo() {
		Assert.assertEquals("Sobrepeso", calc.calcularImc(9.324, 0.7, 2, "M"));
	}

	@Test
	public void testeMenino2anosObesidade() {
		Assert.assertEquals("Obesidade", calc.calcularImc(10.29, 0.7, 2, "M"));
	}

	@Test
	public void testeMenino20anosBaixoPeso() {
	...
	public void testeMenino20anoSobrePesoMinimo() {
		Assert.assertEquals("Sobrepeso", calc.calcularImc(47.32, 1.30, 20, "M"));
	}
	...
	public void testeMenina2anosPesoNormalMinimo() {
		Assert.assertEquals("Peso normal", calc.calcularImc(12.07, 0.9, 2, "F"));
	}

	@Test
	public void testeMenina2anosPesoNormalMaximo() {
		Assert.assertEquals("Peso normal", calc.calcularImc(14.577, 0.9, 2, "F"));
	}

	@Test
	public void testeMenina2anosSobrePesoMinimo() {
		Assert.assertEquals("Sobrepeso", calc.calcularImc(15.39, 0.9, 2, "F"));
	}
	...
	public void testeMenina2anosObesidade() {
		Assert.assertEquals("Obesidade", calc.calcularImc(29.16, 0.9, 2, "F"));
	}
